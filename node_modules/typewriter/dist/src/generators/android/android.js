...
exports.android = {
    ...
    setup: () => __awaiter(this, void 0, void 0, function* () { return ({}); }),
    generateArray: (client, schema, items, parentPath) => __awaiter(this, void 0, void 0, function* () {
        return Object.assign({}, defaultPropertyContext(client, schema, `List<${items.type}>`, parentPath), { isListType: true });
    }),
